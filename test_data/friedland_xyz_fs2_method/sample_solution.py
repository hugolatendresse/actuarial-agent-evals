...
data_dir = '/Users/sabrinatan/code/aria-tests/test_data/friedland_xyz_fs2_method'
...
premium_df = pd.read_csv(f'{data_dir}/earned_premium_and_rate_changes.csv', thousands=',')
