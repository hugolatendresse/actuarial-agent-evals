...
Usage:
  python actuarial_integration_test.py --method friedland_xyz_dev_method --ide cline --mode auto
  python actuarial_integration_test.py --method friedland_xyz_dev_method --ide cline --mode manual
"""
