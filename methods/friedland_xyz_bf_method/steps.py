...
def get_step_1_prompt(step_data: Dict[str, Any]) -> str:
    ...
    prompt = []
    prompt.append("[Bornhuetter-Ferguson Method - STEP 1]: Calculate Bornhuetter-Ferguson Ultimate Claims")
    prompt.append("")
...
def get_step_2_prompt(step_data: Dict[str, Any]) -> str:
    ...
    prompt = []
    prompt.append("[Bornhuetter-Ferguson Method - STEP 2]: Calculate Bornhuetter-Ferguson IBNR")
    prompt.append("")
    prompt.append("Extract the IBNR reserves from the Bornhuetter-Ferguson model and calculate the total.")
    prompt.append("")
