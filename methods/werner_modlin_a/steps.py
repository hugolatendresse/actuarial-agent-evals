...
def get_step_1_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate CY Earned Premiums at Current Rate Level")
    prompt.append("")
    prompt.append(
...
def get_step_2_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate 8-Point Exponential Trend for Average Written Premium")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_3_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Total Premium Trend Factors (Two-Step Trending)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_4_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate CY Projected Earned Premiums at Current Rate Level")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_6_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Current Loss Trend (8-point)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_7_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Projected Loss Trend (4-point)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_8_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Total Loss Trend Factors (Two-Step)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_9_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Projected Loss and LAE Ratio")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_10_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Variable Permissible Loss Ratio")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_13_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Trended Present Rates Indication")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_14_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Werner-Modlin Method]: Calculate Credibility-Weighted Rate Change")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
