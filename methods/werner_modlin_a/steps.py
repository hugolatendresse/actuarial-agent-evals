...
def get_step_5_prompt(step_data: Dict[str, Any]) -> str:
    ...
    prompt.append("Examine the existing code to understand what has been set up.")
    prompt.append("")
    prompt.append("Develop the reported loss+ALAE triangle to ultimate using all-years straight average")
...
def get_step_13_prompt(step_data: Dict[str, Any]) -> str:
    ...
    prompt.append("Examine the existing code to understand what has been set up.")
    prompt.append("")
    prompt.append("Calculate the trended present rates indication (as a rate change, not factor) for the complement of credibility.")
