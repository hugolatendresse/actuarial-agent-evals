...
def get_step_1_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Develop Reported Count to Ultimate")
    prompt.append("")
    prompt.append(
...
def get_step_2_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Trend Claim Counts (AY 2002-2006)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_3_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Calculate On-Level Earned Premiums")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_4_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Calculate Trended Frequency to OLEP (AY 2002-2006)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_5_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Select 2008 Frequency Level")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_6_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Calculate Unadjusted Frequencies (All AYs)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_7_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Project Ultimate Claim Counts (All AYs)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_8_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Develop Severity to Ultimate")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_9_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Adjust Severities to 2008 Level (AY 1998-2006)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_11_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Calculate Unadjusted Severities (AY 2007-2008)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_12_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #2]: Calculate Ultimate and IBNR (AY 2007-2008)")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
