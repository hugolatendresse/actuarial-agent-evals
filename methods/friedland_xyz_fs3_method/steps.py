...
def get_step_1_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Build Disposal Rate Triangle")
    prompt.append("")
    prompt.append(
...
def get_step_2_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Select Disposal Rates by Age")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_3_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Calculate Projected Incremental Closed Claim Count")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_4_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Calculate Incremental Paid Severity Triangle")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_5_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Adjust Incremental Paid Severity to 2008")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_6_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Select Adjusted Severities for Ages 12-60")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_8_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Combine Full Array of Selected Severities")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_9_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Project Unadjusted Incremental Paid Amounts")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
...
def get_step_10_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append(
        "[Frequency-Severity Method #3]: Calculate Total Ultimates by AY")
    prompt.append("")
    prompt.append(
        "Examine the existing code to understand what has been set up.")
    prompt.append("")
