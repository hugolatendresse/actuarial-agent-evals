...
def get_step_1_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 1]: Build Disposal Rate Triangle")
    prompt.append("")
...
def get_step_2_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 2]: Select Disposal Rates by Age")
    prompt.append("")
    prompt.append("Select disposal rates by age using the latest 2 simple average with a 1.00 tail factor.")
    prompt.append("")
    prompt.append("Store the result in a variable called: selected_disposal_rates (list or array of disposal rates)")
    prompt.append("")
    prompt.append("When complete and tested, add this exact line at the end:")
    prompt.append("## STEP COMPLETE - TESTED AND WORKING")
...
def get_step_3_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 3]: Calculate Projected Incremental Closed with Payment Claim Count")
    prompt.append("")
    prompt.append("Project the incremental closed with payment claim count triangle according to the 3rd frequency severity method.")
...
def get_step_4_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 4]: Calculate Incremental Paid Severity Triangle")
    prompt.append("")
...
def get_step_5_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 5]: Calculate Adjusted to 2008 Incremental Paid Severity Triangle")
    prompt.append("")
...
def get_step_6_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 6]: Select Adjusted Incremental Paid Severities (Ages 12-60)")
    prompt.append("")
    prompt.append("Select adjusted incremental paid severities for ages 12-60 using latest 2 simple average.")
    prompt.append("")
    prompt.append("Store the result in a variable called: selected_adjusted_severities (list or array)")
    prompt.append("")
    prompt.append("When complete and tested, add this exact line at the end:")
    prompt.append("## STEP COMPLETE - TESTED AND WORKING")
...
def get_step_7_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 7]: Calculate Tail Severities for Ages 72+ and 84+")
    prompt.append("")
...
def get_step_8_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 8]: Combine Full Array of Selected Severities")
    prompt.append("")
    prompt.append("Combine selected severities from ages 12 to 108-Ultimate.")
    prompt.append("")
    prompt.append("Store the result in a variable called: full_selected_severities (list or array)")
    prompt.append("")
    prompt.append("When complete and tested, add this exact line at the end:")
    prompt.append("## STEP COMPLETE - TESTED AND WORKING")
...
def get_step_9_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 9]: Project Unadjusted Incremental Paid Amounts")
    prompt.append("")
    prompt.append("Project unadjusted incremental paid amounts according to the 3rd frequency severity method.")
    prompt.append("")
...
def get_step_10_prompt(step_data: Dict[str, Any]) -> str:
    prompt = []
    prompt.append("[Frequency-Severity Method #3 - STEP 10]: Calculate Total Ultimates by AY")
    prompt.append("")
    prompt.append("Calculate ultimates by accident year.")
    prompt.append("")
