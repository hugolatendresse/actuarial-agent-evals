...
def get_step_4_prompt(step_data: Dict[str, Any]) -> str:
    ...
    prompt.append("selected projected non-CAT pure premium per exposure using an all-years weighted average.")
    prompt.append("")
...
def get_step_5_prompt(step_data: Dict[str, Any]) -> str:
    ...
    prompt.append("Examine the existing code to understand what has been set up.")
    prompt.append("")
    prompt.append("Using classical credibility and the provided info, weight the selected projected")
